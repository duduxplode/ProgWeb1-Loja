 ...
 *
 */
package br.ueg.api.exception;

import br.ueg.api.util.Util;
...
public abstract class ApiRestResponseExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * @return -
	 */
	protected abstract MessageCode getCodeInternalServerError();

	/**
	 * Método handle referente a exceção {@link br.ueg.api.exception.BusinessException}.
	 * 
	 * @param e  -
	 * @return -
	 */
